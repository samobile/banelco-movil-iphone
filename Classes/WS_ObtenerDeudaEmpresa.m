...
#import "WSUtil.h"
#import "Deuda.h"
@implementation WS_ObtenerDeudaEmpresa

@synthesize userToken, codigo, idCliente;

-(NSString *)getWSName {
	return @"obtenerDeudaEmpresa";
}

// ORIGINAL
//-(NSMutableArray *)getSoapMessage {
//	
//	return  [NSString stringWithFormat:
//			 @"<v:Envelope xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:d=\"http://www.w3.org/2001/XMLSchema\" xmlns:c=\"http://schemas.xmlsoap.org/soap/encoding/\" xmlns:v=\"http://schemas.xmlsoap.org/soap/envelope/\">\n"
//			 "<v:Header />\n"
//			 "<v:Body>\n"
//			 "<n0:obtenerDeudaEmpresa id=\"o0\" c:root=\"1\" xmlns:n0=\"http://mobile.services.pmctas.banelco.com/\">\n"
//			 "<in0 i:type=\"d:string\">%@</in0>\n" 
//			 "<in1 i:type=\"d:string\">%@</in1>\n" 
//			 "<in2 i:type=\"d:string\">%@</in2>\n" 
//			 "</n0:obtenerDeudaEmpresa>\n"
//			 "</v:Body>\n"
//			 "</v:Envelope>\n", userToken, codigo, idCliente
//			 ];
//	
//}
...
-(NSMutableArray *)getSoapMessage {
	...
	return  [NSString stringWithFormat:
			 ...
			 "</n0:obtenerDeudaEmpresa>\n"
			 "</v:Body>\n"
			 "</v:Envelope>\n", userToken, [WSRequest securityToken], codigo, idCliente
			 ];
